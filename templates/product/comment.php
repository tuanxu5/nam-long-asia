							...
							<div class="form-group">
								...
								<div class="review-rating-star">
									<div class="review-rating-star-icon">
										<i class="fa fa-star star-empty" data-value="1" data-text="Kém"></i>
										<i class="fa fa-star star-empty" data-value="2" data-text="Tạm được"></i>
										<i class="fa fa-star star-empty" data-value="3" data-text="Bình thường"></i>
										<i class="fa fa-star star-empty" data-value="4" data-text="Tốt"></i>
										<i class="fa fa-star star-empty" data-value="5" data-text="Rất tốt"></i>
									</div>
									<a class="slogan-comment text-decoration-none "></a>
