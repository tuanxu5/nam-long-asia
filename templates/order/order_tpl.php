								...
								<div class="form-row">
									<div class="pic-procart col-3 col-md-2">
										<a class="text-decoration-none" href="<?=$proinfo[$sluglang]?>" target="_blank" title="<?=$proinfo['name'.$lang]?>">
											<img class="lazy" onerror="this.src='<?=THUMBS?>/85x85x2/assets/images/noimage.png';" data-src="<?=THUMBS?>/85x85x2/<?=$linkPictureItems.$pictureItems?>" alt="<?=$proinfo['name'.$lang]?>" title="<?=$proinfo['name'.$lang]?>"/>
										</a>
