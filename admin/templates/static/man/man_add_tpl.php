                                    ...
                                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                        <?php foreach($config['website']['lang'] as $k => $v) { ?>
                                            <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                                ...
                                                <?php } ?>
                                                <?php if(isset($config['static'][$type]['name1']) && $config['static'][$type]['name1'] == true) { ?>
                                                    <div class="form-group">
                                                        <label for="name1<?=$k?>">Tiêu đề 1 (<?=$k?>):</label>
                                                        <input type="text" class="form-control for-seo text-sm" name="data[name1<?=$k?>]" id="name1<?=$k?>" placeholder="Tiêu đề 1 (<?=$k?>)" value="<?=(!empty($flash->has('name1'.$k))) ? $flash->get('name1'.$k) : @$item['name1'.$k]?>" required>
                                                    </div>
                                                <?php } ?>
