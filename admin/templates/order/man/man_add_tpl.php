	                ...
	                <?php } else { ?>
	                    <tbody>
	                        <?php foreach($order_detail as $k => $v) { 
	                        	$rowDetailProduct = $cart->getProductInfo($v['id_product']);
	                        	if($rowDetailProduct['photo'] == $v['photo']){
	                        		$linkPhotoProduct = UPLOAD_PRODUCT_L;
	                        	}else{
	                        		$linkPhotoProduct = UPLOAD_COLOR_L;
	                        	}
	                        ?>
	                            <tr>
	                                ...
	                                <td class="align-middle">
	                                    <a title="<?=$v['name']?>">
	                                    	<?=$func->getImage(['class' => 'rounded img-preview', 'sizes' => $config['order']['thumb'], 'upload' => $linkPhotoProduct, 'image' => $v['photo'], 'alt' => $v['name']])?>
	                                    </a>
	                                </td>
	                                <td class="align-middle">
