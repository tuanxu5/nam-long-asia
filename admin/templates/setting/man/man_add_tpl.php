			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if(isset($config['setting']['hotline1']) && $config['setting']['hotline1'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="hotline1">Hotline1:</label>
							<input type="text" class="form-control text-sm" name="data[options][hotline1]" id="hotline1" placeholder="Hotline1" value="<?=(!empty($flash->has('hotline1'))) ? $flash->get('hotline1') : @$options['hotline1']?>" required>
						</div>
					<?php } ?>
