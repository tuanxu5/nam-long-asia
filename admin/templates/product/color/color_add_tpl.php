<?php
    $linkMan = "index.php?com=product&act=man_color&type=".$type."&id_product=".$_REQUEST['id_product']."&p=".$curPage;
    $linkSave = "index.php?com=product&act=save_color&type=".$type."&id_product=".$_REQUEST['id_product']."&p=".$curPage;
?>
<!-- Content Header -->
