...
$(document).ready(function(){
	...
	if($(".form-control-ckeditor").length)
	{
		CKEDITOR.editorConfig = function(config){
			...
			/* All Plugins */
			config.extraPlugins = 'image2,texttransform,copyformatting,html5video,html5audio,flash,youtube,wordcount,tableresize,widget,lineutils,clipboard,dialog,dialogui,widgetselection,lineheight,video,videodetector';
