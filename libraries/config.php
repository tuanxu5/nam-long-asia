<?php
    $url = '';
	$dbname = str_replace("/","_",$url);

    //include LIBRARIES."db-connection.php";
	...
	/* Cấu hình coder */
	define('NN_CONTRACT', '467723w');
	define('NN_AUTHOR', 'vophuongduy.nina@gmail.com');
	...
	$config = array(
		...
		'license' => array(
			'version' => "7.1.0",
			'powered' => "vophuongduy.nina@gmail.com"
		)
	);
	...
	/* Redirect http/https */
	if (!count($config['arrayDomainSSL']) && $http == 'http://') {
