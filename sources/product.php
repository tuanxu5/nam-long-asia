<?php  
	...
	if($id!='')
	{
		...
		/* Lấy màu */
		$rowColor = $d->rawQuery("select type_show, photo, color, id from #_color where type='".$type."' and id_product = '".$rowDetail['id']."' and find_in_set('hienthi',status) order by id desc, numb asc");
		/*
